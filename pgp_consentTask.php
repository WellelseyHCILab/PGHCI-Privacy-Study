...
<html>
	...
	<div class="navbar-inner">
		<div class="container">
			<span class="brand"><img src="assets/img/dna.png"> PGHCI: Consent Form Task</span>
		</div>
	</div>
	</div>
    ...
    <p><strong>NOTE: This is not a real consent form. By clicking continue and answering the questions, you are NOT actually consenting to anything testing or sharing of information; we just interested in what people would do. </strong></p>
    ...
    <h1> HCIPGP Consent Form </h1>
        ...
        <ol>
            ...
            <h3><li>Who will have access to my data?</li></h3>
                <p>You will have access to your raw genomic data on an online, password-protected account.  Researchers at the HCIPGP project and our research partners and collaborators will have access to your anonymized genomic and trait data in a private, online database.  In the future, U.S. law enforcement agencies may also be able to audit or subpoena your genomic data, including data that identifies you, such as your name or contact information.</p>
