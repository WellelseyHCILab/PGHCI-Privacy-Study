...
<tr> 
        <th id='empty'></th> 
        <th class='title' onmouseover='newFunction()'>Meta Data<button id="LearnMoreBtn" onclick='openFunction1()'><img src="assets/img/_.png"></button>
            <div id="overlay1"></div>
            <div id="popup1">
        ...
        <th id='head' class='title'  onmouseover='newFunction()'>Core Findings<button id="LearnMoreBtn" onclick='openFunction2()'><img src="assets/img/_.png"></button>
            <div id="overlay2"></div>
            <div id="popup2">
        ...
        <th id='head' class='title'  onmouseover='newFunction()'>Full Data<button id="LearnMoreBtn" onclick='openFunction3()'><img src="assets/img/_.png"></button>
            <div id="overlay3"></div>
            <div id="popup3">
...
<!--HIGHLIGHT FUNCTION-->
<script type="text/javascript" src="scripts/mootools.1.2.3.js"></script>
<script type="text/javascript">
