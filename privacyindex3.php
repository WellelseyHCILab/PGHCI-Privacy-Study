...
$_SESSION['pi3_start_time'] = time(); //start timer
...
<html>
	...
	<div class="navbar-inner">
		<div class="container">
   <span class="brand"><img src="assets/img/dna.png"> PGHCI</span><span class="brand" style="float:right;">Section 3/8</span>
		</div>
	</div>
	</div>
	
	<div class="container" id="study_wrapper">
	<form id="demo_form" method="POST" action="pi3_process.php"><ol> <!--CHECK THIS, J.-->
				
		<h2>PGHCI Survey Part 3</h2>
