	...
	<div class="container" id="compQuestions">
            ...
            <ol>
                ...
                <li> <label for="consent_comp_q2"><p><strong>True or False:  Your data can be combined with the services of an ancestry website to discover unexpected or unknown genealogical features about you and/or your family.</strong></p></label></li>
                 ...
                 <li> <label for="consent_comp_q3"><p><strong>If you provide your genetic and trait data to the HCIPGP study, which of the following people will have access to your data <i>automatically and without your explicit additional consent</i>? Check all that apply.</storng></p></label></li>
                ...
                <li> <label for="consent_comp_q7"><p><strong>Will your name be associated with your genetic material?</strong></p></label></li>
                    ...
                    <input type="radio" name="consent_comp_q7" id="consent_comp_q7_A" value="A">Only to researchers</label>
                    <label class="radio" for="consent_comp_q7_B">
                    <input type="radio" name="consent_comp_q7" id="consent_comp_q7_B" value="B">Only if discoveries are made using my genetic material</label>
                    <label class="radio" for="consent_comp_q7_C">
                    <input type="radio" name="consent_comp_q7" id="consent_comp_q7_C" value="C">Never</label>  
                    <label class="radio" for="consent_comp_q7_D">
                    <input type="radio" name="consent_comp_q7" id="consent_comp_q7_D" value="D">Only to HCIPGP interviewers</label>            
