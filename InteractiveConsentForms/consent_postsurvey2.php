	...
	<div class="container" id="compQuestions">
            ...
            <ol>
                <li> <label for="consent_opin_q1"><p><strong>I am confident in my response to the questions I just answered, questions 1-15</strong></p></label></li>
                    ...
                    <input type="radio" name="consent_opin_q1" id="consent_opin_q1_A" value="A">Strongly Disagree</label>
                    <label class="radio" for="consent_opin_q1_B">
                    <input type="radio" name="consent_opin_q1" id="consent_opin_q1_B" value="B">Disagree</label>
                    <label class="radio" for="consent_opin_q1_C">
                    <input type="radio" name="consent_opin_q1" id="consent_opin_q1_C" value="C">Undecided</label>
                    <label class="radio" for="consent_opin_q1_D">
                    <input type="radio" name="consent_opin_q1" id="consent_opin_q1_D" value="D">Agree</label> 
                    <label class="radio" for="consent_opin_q1_E">
                    <input type="radio" name="consent_opin_q1" id="consent_opin_q1_E" value="E">Strongly Agree</label>  
                ...
                <li> <label for="consent_opin_q2"><p><strong>This consent form was easy to understand</strong></p></label></li>
                    ...
                    <input type="radio" name="consent_opin_q2" id="consent_opin_q2_A" value="A">Strongly Disagree</label>
                    <label class="radio" for="consent_opin_q2_B">
                    <input type="radio" name="consent_opin_q2" id="consent_opin_q2_B" value="B">Disagree</label>
                    <label class="radio" for="consent_opin_q2_C">
                    <input type="radio" name="consent_opin_q2" id="consent_opin_q2_C" value="C">Undecided</label>
                    <label class="radio" for="consent_opin_q2_D">
                    <input type="radio" name="consent_opin_q2" id="consent_opin_q2_D" value="D">Agree</label> 
                    <label class="radio" for="consent_opin_q2_E">
                    <input type="radio" name="consent_opin_q2" id="consent_opin_q2_E" value="E">Strongly Agree</label>     
                ...
                <li> <label for="consent_opin_q3"><p><strong>It was hard to find information in this consent form</strong></p></label></li>
                    ...
                    <input type="radio" name="consent_opin_q3" id="consent_opin_q3_A" value="A">Strongly Disagree</label>
                    <label class="radio" for="consent_opin_q3_B">
                    <input type="radio" name="consent_opin_q3" id="consent_opin_q3_B" value="B">Disagree</label>
                    <label class="radio" for="consent_opin_q3_C">
                    <input type="radio" name="consent_opin_q3" id="consent_opin_q3_C" value="C">Undecided</label>
                    <label class="radio" for="consent_opin_q3_D">
                    <input type="radio" name="consent_opin_q3" id="consent_opin_q3_D" value="D">Agree</label> 
                    <label class="radio" for="consent_opin_q3_E">
                    <input type="radio" name="consent_opin_q3" id="consent_opin_q3_E" value="E">Strongly Agree</label>     
                ...
                <li> <label for="consent_opin_q4"><p><strong>Finding information in the HCIPGP consent form was a pleasurable experience.</strong></p></label></li>
                    ...
                    <input type="radio" name="consent_opin_q4" id="consent_opin_q4_A" value="A">Strongly Disagree</label>
                    <label class="radio" for="consent_opin_q4_B">
                    <input type="radio" name="consent_opin_q4" id="consent_opin_q4_B" value="B">Disagree</label>
                    <label class="radio" for="consent_opin_q4_C">
                    <input type="radio" name="consent_opin_q4" id="consent_opin_q4_C" value="C">Undecided</label>
                    <label class="radio" for="consent_opin_q4_D">
                    <input type="radio" name="consent_opin_q4" id="consent_opin_q4_D" value="D">Agree</label> 
                    <label class="radio" for="consent_opin_q4_E">
                    <input type="radio" name="consent_opin_q4" id="consent_opin_q4_E" value="E">Strongly Agree</label>     
                ...
                <li> <label for="consent_opin_q5"><p><strong>If all privacy policies looked just like this I would be more likely to read them</strong></p></label></li>
                    ...
                    <input type="radio" name="consent_opin_q5" id="consent_opin_q5_A" value="A">Strongly Disagree</label>
                    <label class="radio" for="consent_opin_q5_B">
                    <input type="radio" name="consent_opin_q5" id="consent_opin_q5_B" value="B">Disagree</label>
                    <label class="radio" for="consent_opin_q5_C">
                    <input type="radio" name="consent_opin_q5" id="consent_opin_q5_C" value="C">Undecided</label>
                    <label class="radio" for="consent_opin_q5_D">
                    <input type="radio" name="consent_opin_q5" id="consent_opin_q5_D" value="D">Agree</label> 
                    <label class="radio" for="consent_opin_q5_E">
                    <input type="radio" name="consent_opin_q5" id="consent_opin_q5_E" value="E">Strongly Agree</label>     
         		...
         		<li> <label for="consent_opin_q6"><p><strong>If you were given this consent form with the ability to decide who to share your genomic data with, which of the following options would you choose?</strong></p></label></li>
                    ...
                    <input type="radio" name="consent_opin_q6" id="consent_opin_q6_A" value="A">I would be willing to share my information with HCIPGP researchers and the public in an online, open, anonymized genomic database.</label>
                    <label class="radio" for="consent_opin_q6_B">
                    <input type="radio" name="consent_opin_q6" id="consent_opin_q6_B" value="B">I would be willing to share my genomic information only with HCIPGP researchers in a secure, private database.</label>
                    <label class="radio" for="consent_opin_q6_C">
                    <input type="radio" name="consent_opin_q6" id="consent_opin_q6_C" value="C">I would want to receive my results but I wouldn't want to share my information with either researchers or the public.</label>
                    <label class="radio" for="consent_opin_q6_D">
                    <input type="radio" name="consent_opin_q6" id="consent_opin_q6_D" value="D">I would not want to participate in this study.</label> 
                ...
                <li><label for="consent_opin_q8"><p><strong>Please describe what you liked <em>least</em> about the consent form presented here:</strong></p></label></li>
                 ...
                 <li><label for="consent_opin_q9"><p><strong>Please rank the following risks between 1-12 where 1 is the risk you are <strong>most</strong> concerned about and 12 is the risk you are <strong>least</strong> concerned about.</strong></p></label></li>    
                     <input name="consent_opin_q9" value="4123" type="hidden" />
                     <table>
                        ...
                        <td>
                            <ol id="unranked_q9" class="connectedSortable">
                              ...
                              <li class="ui-state-highlight">Unwanted ancestry discovery</li>
                  ...
                  <li><label for="consent_opin_q10"><p><strong>Please rank the following benefits between 1-7 where 1 provides the <strong>greatest benefit</strong> and 7 provides the <strong>least</strong> benefit.</strong></p></label></li>   
                      <input name="consent_opin_q10" value="213" type="hidden" />
                     <table>
                        <tr><td id="unrankedColumnLabel"><i>Drag each item to the right column to rank</i></td><td id="rankColumnLabel">Ranking</td></tr>
                        <td>
